	...
	<div class="row enteteTeccart">
          <div class = "col-6">
            <ul class="nav navbar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../Pages/indexadmin.php?lien=location">LOCATIONS</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../Pages/indexadmin.php?lien=inventaire">INVENTAIRE</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../Pages/indexadmin.php?lien=clients">CLIENTS</a>
                </li>
